...
section .text
    ...
    fstp qword [sonuc]; sonuc = 5.75, yigindan cek
\end{lstlisting}
\end{ornekkutu}
...
section .text
    ; --- tamsayi -> float ---
    cvtsi2ss xmm0, [tam]   ; XMM0 = 7.0 (float olarak)
...
\begin{lstlisting}
    ...
    ja  a_buyuk        ; a > b ise atla (isaretsiz atlama kullan!)
    jb  b_buyuk        ; a < b ise
...
\begin{lstlisting}
section .data
    dizi  dd 2.0, 4.0, 6.0, 8.0   ; 4 float
    adet  dd 4
    ort   dd 0.0
...
ortalama:
    ...
    mov   esi, dizi        ; ESI = dizi baslangici
.dongu:
    movss xmm1, [esi]      ; siradaki elemani al
    addss xmm0, xmm1       ; toplama ekle
    add   esi, 4           ; sonraki float (4 bayt)
    loop  .dongu           ; ECX-- , sifir degilse devam

    cvtsi2ss xmm1, [adet]  ; XMM1 = 4.0 (adedi float yap)
